...
//consume
  ...
  return (
    <div className="w-11/12 max-w-[670px] py-8 flex flex-col gap-y-7 mt-[66px] mb-[70px] justify-center items-center ml-[29%]">
     {
       loading ? (<Spinner/>):
       (
        posts.length === 0 ? (
        ...
        (posts.map((post)=>(
          <div key={post.id}>
            ...
            <p className="text-sm mt-[4px]">Poseted on {post.data}</p>
